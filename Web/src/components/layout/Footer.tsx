export default function Footer() {
  return (
    <footer id="contact" className="bg-black border-t border-white/10 py-20 mt-20">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="inline-block p-4 bg-white rounded-lg mb-8">
          {/* QR Code Placeholder */}
          <div className="w-32 h-32 bg-gray-200 flex items-center justify-center text-gray-500 text-xs text-center p-2">
            [赛事交流群
            <br />
            二维码]
          </div>
